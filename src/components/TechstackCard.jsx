...
const TechstackCard = ({ items, className }) => {
  ...
  return (
    <div
      className={` grid gap-15 grid-cols-3 md:grid-cols-5 justify-center items-center mx-auto py-[3em] overflow-visible ${
        className || ""
      }`}
    >
      {items.map((item, index) => (
        ...
        >
          ...
          >
            <span
              className="m-auto text-3xl w-[1.5em] h-[1.5em] flex items-center justify-center"
              aria-hidden="true"
            >
              {item.icon}
            </span>
